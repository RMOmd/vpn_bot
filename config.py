...
# Настройки TelegaPay
TELEGAPAY_API_KEY = os.getenv('TELEGAPAY_API_KEY')
TELEGAPAY_BASE_URL = os.getenv('TELEGAPAY_BASE_URL', 'https://secure.telegapay.link')
TELEGAPAY_WEBHOOK_URL = os.getenv('TELEGAPAY_WEBHOOK_URL') 